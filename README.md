...
```bash
cp -r grok-hackathon/.claude/skills/sandbox-twins ~/.agents/skills/
```
...
python3 scripts/pipeline.py <trace.jsonl> --case <dir> --correction <file> --out worlds/<name>   # headless twin build
```
